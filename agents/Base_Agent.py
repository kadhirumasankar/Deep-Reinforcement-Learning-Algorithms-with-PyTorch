...
class Base_Agent(object):
    ...
    def get_action_size(self):
        ...
        if self.environment_title == "PredatorPrey":
            return self.environment.action_space.nvec.item()
        elif self.action_types == "DISCRETE":
    ...
    def log_to_tensorboard(self):
        self.tensorboard_writer.add_scalar(
            "Score", self.game_full_episode_scores[-1], self.episode_number + 1
        )
        self.tensorboard_writer.add_scalar(
            "MaxScoreSeen", self.max_episode_score_seen, self.episode_number + 1
        )
        self.tensorboard_writer.add_scalar(
            "RollingScore", self.rolling_results[-1], self.episode_number + 1
        )
        self.tensorboard_writer.add_scalar(
